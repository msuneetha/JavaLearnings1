package com.semanticsquare.books.controllers;
...
import com.semanticsquare.books.manager.BooksManager;
 ...
 */
@WebServlet("/mybooks") // This is needed to identify this java class as servelet and needed when used in url with /mybooks otherwise its not recognizing
public class MyBooks extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//get data from model		
		Collection<Books> books = BooksManager.getInstance().getMyBooks();		
