...
public class DataStore {
	...
	public static final int TOTAL_USERS_COUNT = 5;
	...
	private static User[] users = new User[TOTAL_USERS_COUNT];
	...
	private static UserBookmark[] userBookmarks = new UserBookmark[TOTAL_USERS_COUNT * USER_BOOKMARK_LIMIT];
