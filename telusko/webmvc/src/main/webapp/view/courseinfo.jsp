...
<div class="container">
    ...
    <div class="course-info cid">Product Id is : ${pid}</div>
    <div class="course-info cname">Product Name is : ${pname}</div>
    <div class="course-info cost">Product Cost is : ${pcost}</div>
